  ...
  return (
    ...
    <div className="relative h-fit ">
      ...
      <div className=" relative z-10 flex justify-around  items-center mt-12 md-12 px-4  ">
        <div className=" md:h-80 _890:h-auto flex flex-col sm:flex-row w-full bg-white  rounded-xl overflow-hidden space-x-8 p-5 max-w-[80%] shadow-2xl">
          {/* Image */}
          ...
          <div className="w-full sm:w-1/2 p-6 flex flex-col justify-center">
            <h2 className="text-2xl font-bold mb-4 font-playpen md:text-xl _890:text-2xl">Leather Shoes for Every Occasion</h2>
            <p className="text-lg md:text-sm _890:text-lg">
      ...
      <div className="relative z-10 flex justify-around  items-center mt-12 md-12 px-4 ">
        <div className="flex flex-col md:h-[24rem] _890:h-auto sm:flex-row w-full bg-white  rounded-xl shadow-2xl overflow-hidden space-x-8 p-5 max-w-[80%]">
          
          {/* Text */}
          <div className="w-full sm:w-1/2 p-6 flex flex-col justify-center">
            <h2 className="text-2xl font-bold mb-4 font-playpen md:text-xl _890:text-2xl">Craftsmanship and Passion</h2>
            <p className="text-lg md:text-sm _890:text-lg">
      ...
      <div className="relative z-10 flex justify-around  items-center mt-12 md-12 px-4 ">
        <div className="flex md:h-[18rem] _890:h-auto flex-col sm:flex-row w-full bg-white  rounded-xl shadow-2xl overflow-hidden space-x-8 p-5 max-w-[80%]">
          ...
          {/* Text */}
          <div className="w-full sm:w-1/2 p-6 flex flex-col justify-center">
            <h2 className="text-2xl font-bold md:text-xl mb-4 font-playpen _890:text-2xl">Get in Touch</h2>
            <p className="text-lg md:text-sm _890:text-lg">
